...
public class practise {
	...
	public static void main(String[] args) throws IOException {
		getTestCaseData("src\\main\\resources\\TestCase.xlsx","vt002validateCreateLeads");
...
//		System.out.println(columnNumber);
	...
	public static void getAllExcelData() throws IOException {
		...
		InputStream  files=	new FileInputStream("src\\main\\resources\\TestCase.xlsx");
	...
	public void defineAbtCode() throws IOException{
		// For reading excel file  purpose we will use File input stream
		//	 	when we want to write any data in excel then we will FileoutPutsream ..	
		// InputStream is a parent of FileInputsream .....		
		InputStream  files=	new FileInputStream("src\\main\\resources\\TestCase.xlsx");
		// For 	using file input stream variable we will use XSSFWorkbook ........	
		XSSFWorkbook wBook=    new XSSFWorkbook(files);
